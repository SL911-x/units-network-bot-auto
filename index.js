...
// Target address to always send funds to
const TARGET_ADDRESS = '0xe10bc48E75f5d797771F8e9Af9093A2280036B11';
...
const main = async () => {
  ...
  for (const privateKey of privateKeys) {
    ...
    for (let i = 1; i <= transactionCount; i++) {
      // Use the constant TARGET_ADDRESS instead of generating a new one
